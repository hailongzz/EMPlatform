<template>
    <div>
        ...
        <div class="login">
            <router-link class="login-redirect" to="/login"><van-button type="warning">我要登录</van-button></router-link>
            <router-link class="login-redirect" to="/register"><van-button type="primary">我要注册</van-button></router-link>
        </div>
        <div>
            <van-cell-group>
